...
namespace PinionCore.Utility
{
    ...
    public class Map<TKey, TVal> : Dictionary<TKey, TVal>, IXmlSerializable, ISerializable
    {
        ...
        /*public static implicit operator PinionCore.Utility.Map<TKey, TKey>(Object[] value)
		{
			PinionCore.Utility.Map<TKey, TKey> qn = new Utility.Map<TKey, TKey>();
			if (value != null)
			{
				Object[] parts = (Object[])value;
        ...
        private const string DictionaryNodeName = "PinionCore.Utility.Map";
